...
class View:
    ...
    def list_notebook_default(self, notebook_default):
        for notebook in notebook_default:
            return notebook.name

    # def print_notebook_default(self, notebook_default):
    #     for item in notebook_default:
    #         print(item)

    def list_notes(self, notes):
        for note in notes:
            print(note.idNotebook, note.idNote, note.title)
